...
\title{\Huge{
  \indexspace \textbf{Politechnika Poznańska Wydział Elektryczny Instytut Automatyki, Robotyki i Inżynierii Informatycznej}  \indexspace Telefonia IP \indexspace Komunikator głosowy VoIP \indexspace \textbf{"Pytler"}}}
...
\begin{document}
  ...
  \begin{enumerate}
    ...
    \item Zalogowany użytkownik ma możliwość ustawienia opisu, który będzie wyświetlany jego znajomym.
  ...
  \begin{enumerate}
    ...
    \item Połączenia szyfrowane używają szyfrowania symetrycznego z wymianą kluczy poprzez algorytm Diffiego-Hellmana.
  \end{enumerate}
  \section{Narzędzia}
